...
public class GamePanel extends JPanel{ 	
	...
	private JButton goback =  new JButton(new ImageIcon(this.getClass().getClassLoader().getResource("Yes.png"))); //게임종료 시 다시 시작하겠냐는 물음에 응답하는 Yes버튼
...
//	private boolean iAmCorrect  = false; //내가 맞췄음을 나타낼 변수
	...
	public void setYesAndNo() {
		...
		goback.addMouseListener(new MouseCursorEvent()); //마우스커서 이벤트 추가
		
		goback.setBounds(240, 590, 500, 140);
